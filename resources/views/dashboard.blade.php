                        ...
                        <tbody>
                            @foreach ($vehicles as $vehicle)
                                <tr
                                    ...
                                    <td class="px-6 py-4">
                                        <img src="{{ url('storage/images/' . $vehicle->imagePath) }}">
                                    </td>
                                    <td class="px-6 py-4">
                                        {{ $vehicle->year }}
                                    </td>
                                    ...
                                    <td class="px-6 py-4">
                                        Rp. {{number_format(($vehicles->sum('price')),0,',','.')}}
                                    </td>
                                    @if ($vehicle->car)
                                        <td class="px-6 py-4">
                                            Car
                                    ...
                                    <td class="px-6 py-4 text-right">
                                        <form action="{{ route('vehicle.destroy', ['vehicle' => $vehicle]) }}"
                                            ...
                                            @method('DELETE')
                                            <button type="submit"
                                                class="m-1 inline-flex text-white focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-2 py-1.5 text-center bg-red-600 hover:bg-red-700 focus:ring-red-800">
                                                <span class="material-symbols-outlined">
                                                    delete
                                                </span></button>
                                        </form>
                    ...
                    <div class="grid gap-4 mb-4 grid-cols-2">
                        ...
                        <div class="col-span-2">
                            <label for="image"
                                ...
                                image</label>
                            <input type="file" name="image" id="image" class="text-white" required="">
                        </div>
                        <div class="col-span-2">
                            <div class="text-white text-sm font-medium mb-2">Select Type</div>
                            <div id="carButton"
                                class="border border-transparent text-white inline-flex items-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                                onclick="carsSelected()">Cars</div>
                            <div id="truckButton"
                                class="mx-1 border border-transparent text-white inline-flex items-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                                onclick="truckSelected()">Truck</div>
                            <div id="motorbikeButton"
                                class="border border-transparent text-white inline-flex items-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                                onclick="motorbikeSelected()">Motorbike</div>
                        </div>
                        ...
                        <div id="carSelectedDiv" class="hidden col-span-2">
                            ...
                            <div class="col-span-2">
                                <label for="trunkSize"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Trunk Area
                                    Size</label>
                        ...
                        <div id="truckSelectedDiv" class="hidden col-span-2">
                            <div class="col-span-2 mb-2">
                                <label for="tiresCount"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tires
                                    Count</label>
                            ...
                            <div class="col-span-2">
                                <label for="cargoSize"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Cargo Area
                                    Size</label>
                        ...
                        <div id="motorbikeSelectedDiv" class="hidden col-span-2">
                            <div class="col-span-2 mb-2">
                                <label for="storageSize"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Storage Area
                                    Size</label>
